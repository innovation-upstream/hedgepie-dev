...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "hero-pattern":
          "url('https://res.cloudinary.com/dalyoko/f_auto,q_80/hedgepie/Background.jpg')",
        "coin-pattern": `url('https://res.cloudinary.com/dalyoko/f_auto,q_80/hedgepie/Frame_1000002141.png')`,
        "background-gradient":
          "url('https://res.cloudinary.com/dalyoko/f_auto,q_80/hedgepie/Background-gradient.png')",
