...
describe("BeltSingleStakingAdapter Integration Test", function () {
  before("Deploy contract", async function () {
    ...
    const stakingToken = "0xE0e514c71282b6f4e823703a39374Cf58dc3eA4f" // Belt Token
    ...
    const beltAdapter = await ethers.getContractFactory("BeltSingleStakeAdapter");
    ...
    console.log("BeltSingleStakeAdapter: ", this.aAdapter.address);
  });
